...
print("=" * 70)
print("MOUSE IMAGE DOWNLOADER - 2000 IMAGES")
print("Bulletproof with gap filling and duplicate detection")
print("=" * 70)

TARGET_IMAGES = 2000
OUTPUT_FOLDER = "mouse_dataset_2000"
STATE_FILE = "download_state_mouse.json"
...
SEARCH_QUERIES = [
    ...
    "mouse and keyboard",
    "computer mouse white background",
    "mouse close up",
    ...
    "mouse product photo",
    "computer mouse side view",
    "mouse top view",
    "cordless mouse",
    "trackball mouse",
    "vertical mouse",
    "mouse for computer",
    "computer mouse professional",
    "mouse office equipment",
    "computer mouse black background",
    "mouse technology",
    "computer accessory mouse",
    "mouse scroll wheel",
    "computer mouse macro",
    "mouse DPI",
    "computer mouse brand new",
    "mouse unboxing"
]
...
def scan_existing_images():
    print("\nScanning existing mouse images...")
    existing_indices = set()
    existing_hashes = {}

    if os.path.exists(OUTPUT_FOLDER):
        for filename in os.listdir(OUTPUT_FOLDER):
            if filename.startswith('mouse_') and filename.endswith('.jpg'):
                try:
...
def main():
    ...
    if len(existing_indices) >= TARGET_IMAGES:
        print("\nALREADY HAVE 2000 MOUSE IMAGES!")
        return
    ...
    while current_target_idx < len(target_indices):
        ...
        for url_idx, url in enumerate(image_urls):
            ...
            img_path = os.path.join(OUTPUT_FOLDER, f"mouse_{target_index:04d}.jpg")
    ...
    if len(final_indices) >= TARGET_IMAGES:
        print("   SUCCESS! 2000 mouse images complete!")
    else:
