...
print("=" * 70)
print("KEYBOARD IMAGE DOWNLOADER - 2000 IMAGES")
print("Bulletproof with gap filling and duplicate detection")
print("=" * 70)

TARGET_IMAGES = 2000
OUTPUT_FOLDER = "keyboard_dataset_2000"
STATE_FILE = "download_state_keyboard.json"
...
SEARCH_QUERIES = [
    ...
    "mechanical keyboard",
    "keyboard isolated",
    "keyboard white background",
    "keyboard black background",
    "gaming keyboard",
    "wireless keyboard",
    "keyboard close up",
    "keyboard keys",
    "keyboard product photo",
    "keyboard front view",
    "keyboard top view",
    "keyboard RGB",
    "office keyboard",
    ...
    "keyboard brand",
    "keyboard studio shot",
    "keyboard backlit",
    "keyboard keys macro",
    "keyboard layout",
    "keyboard transparent background",
    "keyboard flat lay",
    "keyboard technology",
...
def scan_existing_images():
    print("\nScanning existing keyboard images...")
    existing_indices = set()
    existing_hashes = {}

    if os.path.exists(OUTPUT_FOLDER):
        for filename in os.listdir(OUTPUT_FOLDER):
            if filename.startswith('keyboard_') and filename.endswith('.jpg'):
                try:
...
def main():
    ...
    if len(existing_indices) >= TARGET_IMAGES:
        print("\nALREADY HAVE 2000 KEYBOARD IMAGES!")
        return
    ...
    while current_target_idx < len(target_indices):
        ...
        for url_idx, url in enumerate(image_urls):
            ...
            img_path = os.path.join(OUTPUT_FOLDER, f"keyboard_{target_index:04d}.jpg")
    ...
    if len(final_indices) >= TARGET_IMAGES:
        print("   SUCCESS! 2000 keyboard images complete!")
    else:
