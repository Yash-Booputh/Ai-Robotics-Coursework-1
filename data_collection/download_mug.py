...
print("=" * 70)
print("MUG IMAGE DOWNLOADER - 2000 IMAGES")
print("Bulletproof with gap filling and duplicate detection")
print("=" * 70)

TARGET_IMAGES = 2000
OUTPUT_FOLDER = "mug_dataset_2000"
STATE_FILE = "download_state_mug.json"
MIN_IMAGE_SIZE = (200, 200)

SEARCH_QUERIES = [
    "coffee mug",
    "ceramic mug",
    "mug white background",
    "mug isolated",
    "coffee cup",
    "tea mug",
    "office mug",
    ...
    "mug studio shot",
    "ceramic cup",
    "mug black background",
    "mug transparent background",
    "coffee mug isolated",
    "mug brand",
    "mug corporate",
    "mug gift",
...
def scan_existing_images():
    print("\nScanning existing mug images...")
    existing_indices = set()
    existing_hashes = {}

    if os.path.exists(OUTPUT_FOLDER):
        for filename in os.listdir(OUTPUT_FOLDER):
            if filename.startswith('mug_') and filename.endswith('.jpg'):
                try:
...
def main():
    ...
    while current_target_idx < len(target_indices):
        ...
        for url_idx, url in enumerate(image_urls):
            ...
            img_path = os.path.join(OUTPUT_FOLDER, f"mug_{target_index:04d}.jpg")
    ...
    if len(final_indices) >= TARGET_IMAGES:
        print("   SUCCESS! 2000 mug images complete!")
    else:
